...
/**
 * TDD for the foundation migration (build-plan §3 T1.3 / §4 Phase 1).
 * Applies migrations/000_init_foundation.sql to a throwaway MariaDB test DB and
 * verifies the tenant-scoped foundation (FR-042, FRD §12.2) plus seeded roles.
 */
